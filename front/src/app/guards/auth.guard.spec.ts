...
describe('AuthGuard', () => {
    ...
    // Test pour vérifier que l'utilisateur authentifié peut accéder à la route
    ...
    // Test pour vérifier que l'utilisateur non authentifié est redirigé vers la page de connexion
